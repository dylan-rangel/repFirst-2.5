...
public final class ScreensShadowNode extends LayoutShadowNode {
    ...
    public void onBeforeLayout(NativeViewHierarchyOptimizer nativeViewHierarchyOptimizer) {
        ...
        uIManagerModule.addUIBlock(new UIBlock() { // from class: com.swmansion.rnscreens.ScreensShadowNode$$ExternalSyntheticLambda0
            ...
            public final void execute(NativeViewHierarchyManager nativeViewHierarchyManager) {
                ScreensShadowNode.m209onBeforeLayout$lambda0(ScreensShadowNode.this, nativeViewHierarchyManager);
            }
        });
    }
    ...
    public static final void m209onBeforeLayout$lambda0(ScreensShadowNode this$0, NativeViewHierarchyManager nativeViewHierarchyManager) {
