...
public class CatalystInstanceImpl implements CatalystInstance {
    ...
    /* synthetic */ CatalystInstanceImpl(ReactQueueConfigurationSpec reactQueueConfigurationSpec, JavaScriptExecutor javaScriptExecutor, NativeModuleRegistry nativeModuleRegistry, JSBundleLoader jSBundleLoader, JSExceptionHandler jSExceptionHandler, AnonymousClass1 anonymousClass1) {
    ...
    class AnonymousClass1 implements Runnable {
        ...
        public void run() {
            ...
            CatalystInstanceImpl.this.getReactQueueConfiguration().getJSQueueThread().runOnQueue(new RunnableC00141());
        }
