...
public class ReactTextInputManager extends BaseViewManager<ReactEditText, LayoutShadowNode> {
    ...
    private final class ReactTextInputTextWatcher implements TextWatcher {
        ...
        public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
            ...
            FabricViewStateManager mFabricViewStateManager = this.mEditText.getMFabricViewStateManager();
            if (mFabricViewStateManager.hasStateWrapper()) {
                mFabricViewStateManager.setState(new FabricViewStateManager.StateUpdateCallback() { // from class: com.facebook.react.views.textinput.ReactTextInputManager.ReactTextInputTextWatcher.1
    ...
    public Object updateState(ReactEditText reactEditText, ReactStylesDiffMap reactStylesDiffMap, StateWrapper stateWrapper) {
        FabricViewStateManager mFabricViewStateManager = reactEditText.getMFabricViewStateManager();
        if (!mFabricViewStateManager.hasStateWrapper()) {
