    ...
    public void setSource(ReadableArray readableArray) {
        ...
        if (readableArray == null || readableArray.size() == 0) {
            ...
            if (readableArray.size() == 1) {
                ...
                ImageSource imageSource = new ImageSource(getContext(), map.getString(RNFetchBlobConst.DATA_ENCODE_URI));
                if (Uri.EMPTY.equals(imageSource.getUri())) {
                    warnImageSource(map.getString(RNFetchBlobConst.DATA_ENCODE_URI));
                ...
                for (int i = 0; i < readableArray.size(); i++) {
                    ...
                    ImageSource imageSource2 = new ImageSource(getContext(), map2.getString(RNFetchBlobConst.DATA_ENCODE_URI), map2.getDouble("width"), map2.getDouble("height"));
                    if (Uri.EMPTY.equals(imageSource2.getUri())) {
                        warnImageSource(map2.getString(RNFetchBlobConst.DATA_ENCODE_URI));
