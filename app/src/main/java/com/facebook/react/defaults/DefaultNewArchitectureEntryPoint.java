...
public final class DefaultNewArchitectureEntryPoint {
    ...
    @JvmStatic
    public static final void load(boolean turboModulesEnabled2, boolean fabricEnabled2, boolean concurrentReactEnabled2, String dynamicLibraryName) {
        Intrinsics.checkNotNullParameter(dynamicLibraryName, "dynamicLibraryName");
        ReactFeatureFlags.useTurboModules = turboModulesEnabled2;
        ReactFeatureFlags.enableFabricRenderer = fabricEnabled2;
        fabricEnabled = fabricEnabled2;
        turboModulesEnabled = turboModulesEnabled2;
        concurrentReactEnabled = concurrentReactEnabled2;
