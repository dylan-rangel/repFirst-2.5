            ...
            try {
                ...
                build.newCall(url.build()).enqueue(new Callback() { // from class: com.facebook.react.modules.network.NetworkingModule.2
                    ...
                    public void onFailure(Call call, IOException iOException) {
                        ...
                        ResponseUtil.onRequestError(eventEmitter, i, str6, iOException);
                    }
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        ...
                        NetworkingModule.this.removeRequest(i);
                        ResponseUtil.onResponseReceived(eventEmitter, i, response.code(), NetworkingModule.translateHeaders(response.headers()), response.request().url().getUrl());
                        try {
