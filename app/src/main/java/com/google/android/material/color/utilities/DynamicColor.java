...
public final class DynamicColor {
    ...
    public double getTone(final DynamicScheme dynamicScheme) {
        ...
        if (apply != null) {
            ...
            if (z) {
                r10 = z2 ? Contrast.ratioOfTones(this.toneMinContrast.apply(dynamicScheme).doubleValue(), apply.toneMinContrast.apply(dynamicScheme).doubleValue()) : 1.0d;
                d = ratioOfTones;
            } else {
                ...
                r10 = z2 ? Math.min(ratioOfTones2, ratioOfTones) : 1.0d;
                if (z2) {
