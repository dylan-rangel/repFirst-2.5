...
public final class SentryTracer implements ITransaction {
    ...
    public void finish(SpanStatus spanStatus, SentryDate sentryDate, boolean z) {
        ...
        if (!this.transactionOptions.isWaitForChildren() || hasAllChildrenFinished()) {
            ...
            List<PerformanceCollectionData> m225lambda$start$0$iosentryDefaultTransactionPerformanceCollector = transactionPerformanceCollector != null ? transactionPerformanceCollector.m225lambda$start$0$iosentryDefaultTransactionPerformanceCollector(this) : null;
            ProfilingTraceData onTransactionFinish = (Boolean.TRUE.equals(isSampled()) && Boolean.TRUE.equals(isProfileSampled())) ? this.hub.getOptions().getTransactionProfiler().onTransactionFinish(this, m225lambda$start$0$iosentryDefaultTransactionPerformanceCollector) : null;
            if (m225lambda$start$0$iosentryDefaultTransactionPerformanceCollector != null) {
                m225lambda$start$0$iosentryDefaultTransactionPerformanceCollector.clear();
            }
            ...
            this.hub.configureScope(new ScopeCallback() { // from class: io.sentry.SentryTracer$$ExternalSyntheticLambda0
                ...
                public final void run(Scope scope) {
                    SentryTracer.this.m239lambda$finish$1$iosentrySentryTracer(scope);
                }
            });
    ...
    /* synthetic */ void m239lambda$finish$1$iosentrySentryTracer(final Scope scope) {
        scope.withTransaction(new Scope.IWithTransaction() { // from class: io.sentry.SentryTracer$$ExternalSyntheticLambda2
            @Override // io.sentry.Scope.IWithTransaction
            public final void accept(ITransaction iTransaction) {
                SentryTracer.this.m238lambda$finish$0$iosentrySentryTracer(scope, iTransaction);
            }
        });
    }

    /* renamed from: lambda$finish$0$io-sentry-SentryTracer, reason: not valid java name */
    /* synthetic */ void m238lambda$finish$0$iosentrySentryTracer(Scope scope, ITransaction iTransaction) {
    ...
    private ISpan createChild(SpanId spanId, String str, String str2, SentryDate sentryDate, Instrumenter instrumenter, SpanOptions spanOptions) {
        ...
        Span span = new Span(this.root.getTraceId(), spanId, this, str, this.hub, sentryDate, spanOptions, new SpanFinishedCallback() { // from class: io.sentry.SentryTracer$$ExternalSyntheticLambda1
            ...
            public final void execute(Span span2) {
                SentryTracer.this.m237lambda$createChild$2$iosentrySentryTracer(span2);
            }
        });
    ...
    /* synthetic */ void m237lambda$createChild$2$iosentrySentryTracer(Span span) {
