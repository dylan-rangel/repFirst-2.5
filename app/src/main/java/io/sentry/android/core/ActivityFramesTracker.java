...
public final class ActivityFramesTracker {
        ...
        if (isFrameMetricsAggregatorAvailable()) {
            runSafelyOnUiThread(new Runnable() { // from class: io.sentry.android.core.ActivityFramesTracker$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    ActivityFramesTracker.this.m242xd056273f(activity);
                }
    ...
    /* synthetic */ void m242xd056273f(Activity activity) {
    ...
    public synchronized void setMetrics(final Activity activity, SentryId sentryId) {
        if (isFrameMetricsAggregatorAvailable()) {
            runSafelyOnUiThread(new Runnable() { // from class: io.sentry.android.core.ActivityFramesTracker$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    ActivityFramesTracker.this.m244lambda$setMetrics$1$iosentryandroidcoreActivityFramesTracker(activity);
                }
            }, null);
    ...
    /* synthetic */ void m244lambda$setMetrics$1$iosentryandroidcoreActivityFramesTracker(Activity activity) {
    ...
    public synchronized void stop() {
        if (isFrameMetricsAggregatorAvailable()) {
            runSafelyOnUiThread(new Runnable() { // from class: io.sentry.android.core.ActivityFramesTracker$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    ActivityFramesTracker.this.m245lambda$stop$2$iosentryandroidcoreActivityFramesTracker();
                }
    ...
    /* synthetic */ void m245lambda$stop$2$iosentryandroidcoreActivityFramesTracker() {
        ...
        try {
            if (AndroidMainThreadChecker.getInstance().isMainThread()) {
                ...
                this.handler.post(new Runnable() { // from class: io.sentry.android.core.ActivityFramesTracker$$ExternalSyntheticLambda3
                    @Override // java.lang.Runnable
                    public final void run() {
                        ActivityFramesTracker.this.m243x49051cca(runnable, str);
                    }
                });
            }
    ...
    /* synthetic */ void m243x49051cca(Runnable runnable, String str) {
        try {
            runnable.run();
        } catch (Throwable unused) {
            if (str != null) {
