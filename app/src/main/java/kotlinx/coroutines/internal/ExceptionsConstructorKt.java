...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                m303constructorimpl = Result.m303constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
        ...
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$safeCtor$1
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    ...
                    m303constructorimpl = Result.m303constructorimpl(invoke);
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.INSTANCE;
                    m303constructorimpl = Result.m303constructorimpl(ResultKt.createFailure(th2));
                }
                return (Throwable) (Result.m309isFailureimpl(m303constructorimpl) ? null : m303constructorimpl);
            }
        };
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            m303constructorimpl = Result.m303constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m303constructorimpl = Result.m303constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m309isFailureimpl(m303constructorimpl)) {
            m303constructorimpl = valueOf;
        }
        return ((Number) m303constructorimpl).intValue();
    }
