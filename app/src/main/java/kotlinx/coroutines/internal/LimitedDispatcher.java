...
public final class LimitedDispatcher extends CoroutineDispatcher implements Delay {
    ...
    public void mo1862scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo1862scheduleResumeAfterDelay(timeMillis, continuation);
    }
        ...
        public void run() {
            ...
            while (true) {
                ...
                if (i >= 16 && LimitedDispatcher.this.dispatcher.isDispatchNeeded(LimitedDispatcher.this)) {
                    LimitedDispatcher.this.dispatcher.mo1861dispatch(LimitedDispatcher.this, this);
                    return;
                }
            }
        }
    ...
    public void mo1861dispatch(CoroutineContext context, Runnable block) {
        ...
        this.dispatcher.mo1861dispatch(this, new Worker(obtainTaskOrDeallocateWorker));
    }
