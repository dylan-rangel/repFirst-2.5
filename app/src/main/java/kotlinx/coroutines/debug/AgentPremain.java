...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m303constructorimpl = Result.m303constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m303constructorimpl = Result.m303constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m309isFailureimpl(m303constructorimpl) ? null : m303constructorimpl);
