...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object m1834trySendImplMj0NB7M = conflatedBufferedChannel.m1834trySendImplMj0NB7M(e, true);
        if (m1834trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m1820exceptionOrNullimpl(m1834trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object m1834trySendImplMj0NB7M = conflatedBufferedChannel.m1834trySendImplMj0NB7M(e, true);
        if (!(m1834trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo1806trySendJP2dKIU(E element) {
        return m1834trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m1834trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m1832trySendDropLatestMj0NB7M(element, isSendOp) : m1833trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m1832trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException callUndeliveredElementCatchingException$default;
        Object mo1806trySendJP2dKIU = super.mo1806trySendJP2dKIU(element);
        if (ChannelResult.m1826isSuccessimpl(mo1806trySendJP2dKIU) || ChannelResult.m1824isClosedimpl(mo1806trySendJP2dKIU)) {
            return mo1806trySendJP2dKIU;
        }
        ...
        return ChannelResult.INSTANCE.m1831successJP2dKIU(Unit.INSTANCE);
    }

    /* renamed from: trySendDropOldest-JP2dKIU, reason: not valid java name */
    private final Object m1833trySendDropOldestJP2dKIU(E element) {
        ...
        while (true) {
            ...
            if (channelSegment2.id != j2) {
                ...
                if (findSegmentSend != null) {
                    ...
                    return ChannelResult.INSTANCE.m1829closedJP2dKIU(getSendException());
                }
            } else {
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object mo1806trySendJP2dKIU = mo1806trySendJP2dKIU(element);
        if (!(mo1806trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(mo1806trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m1820exceptionOrNullimpl(mo1806trySendJP2dKIU);
