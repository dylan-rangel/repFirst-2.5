...
public interface SendChannel<E> {
    ...
    Object mo1806trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo1806trySendJP2dKIU = sendChannel.mo1806trySendJP2dKIU(e);
            if (ChannelResult.m1826isSuccessimpl(mo1806trySendJP2dKIU)) {
                return true;
            }
            Throwable m1820exceptionOrNullimpl = ChannelResult.m1820exceptionOrNullimpl(mo1806trySendJP2dKIU);
