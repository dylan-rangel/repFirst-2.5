...
public final class ChannelResult<T> {
    ...
    public static final /* synthetic */ ChannelResult m1816boximpl(Object obj) {
        return new ChannelResult(obj);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <T> Object m1817constructorimpl(Object obj) {
        return obj;
    }
    ...
    public static final boolean m1826isSuccessimpl(Object obj) {
        return !(obj instanceof Failed);
    }

    /* renamed from: isFailure-impl, reason: not valid java name */
    public static final boolean m1825isFailureimpl(Object obj) {
        return obj instanceof Failed;
    }

    /* renamed from: isClosed-impl, reason: not valid java name */
    public static final boolean m1824isClosedimpl(Object obj) {
        return obj instanceof Closed;
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getOrNull-impl, reason: not valid java name */
    public static final T m1821getOrNullimpl(Object obj) {
    ...
    public static final T m1822getOrThrowimpl(Object obj) {
        if (!(obj instanceof Failed)) {
            return obj;
        }
    ...
    public static final Throwable m1820exceptionOrNullimpl(Object obj) {
    ...
    public static final class Companion {
        ...
        public final <E> Object m1831successJP2dKIU(E value) {
            return ChannelResult.m1817constructorimpl(value);
        }

        /* renamed from: failure-PtdJZtk, reason: not valid java name */
        public final <E> Object m1830failurePtdJZtk() {
            return ChannelResult.m1817constructorimpl(ChannelResult.failed);
        }

        /* renamed from: closed-JP2dKIU, reason: not valid java name */
        public final <E> Object m1829closedJP2dKIU(Throwable cause) {
            return ChannelResult.m1817constructorimpl(new Closed(cause));
        }
    }

    public String toString() {
        return m1827toStringimpl(this.holder);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m1827toStringimpl(Object obj) {
        if (obj instanceof Closed) {
