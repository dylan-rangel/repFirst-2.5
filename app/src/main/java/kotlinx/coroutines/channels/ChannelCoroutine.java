...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo1810receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo1810receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo1811tryReceivePtdJZtk() {
        return this._channel.mo1811tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo1806trySendJP2dKIU(E element) {
        return this._channel.mo1806trySendJP2dKIU(element);
    }
