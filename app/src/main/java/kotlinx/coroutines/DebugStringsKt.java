...
public final class DebugStringsKt {
    ...
    public static final String toDebugString(Continuation<?> continuation) {
        ...
        try {
            ...
            m303constructorimpl = Result.m303constructorimpl(continuation + '@' + getHexAddress(continuation));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m303constructorimpl = Result.m303constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m306exceptionOrNullimpl(m303constructorimpl) != null) {
            m303constructorimpl = continuation.getClass().getName() + '@' + getHexAddress(continuation);
        }
