...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo1862scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m1792delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1793toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1793toDelayMillisLRDsOJo(long j) {
        if (Duration.m1628compareToLRDsOJo(j, Duration.INSTANCE.m1731getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1647getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
