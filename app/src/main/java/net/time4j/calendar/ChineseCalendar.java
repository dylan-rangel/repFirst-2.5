...
public final class ChineseCalendar extends EastAsianCalendar<Unit, ChineseCalendar> implements LocalizedPatternSupport {
    ...
    private static class YearOfEraRule implements IntElementRule<ChineseCalendar> {
        ...
        public int getInt(ChineseCalendar chineseCalendar) {
            ...
            return relatedGregorianYear < 1662 ? (relatedGregorianYear - 1644) + 1 : relatedGregorianYear < 1723 ? (relatedGregorianYear - 1662) + 1 : relatedGregorianYear < 1736 ? (relatedGregorianYear - 1723) + 1 : relatedGregorianYear < 1796 ? (relatedGregorianYear - 1736) + 1 : relatedGregorianYear < 1821 ? (relatedGregorianYear - 1796) + 1 : relatedGregorianYear < 1851 ? (relatedGregorianYear - 1821) + 1 : relatedGregorianYear < 1862 ? (relatedGregorianYear - 1851) + 1 : relatedGregorianYear < 1875 ? (relatedGregorianYear - 1862) + 1 : relatedGregorianYear < 1909 ? (relatedGregorianYear - 1875) + 1 : chineseCalendar.getDaysSinceEpochUTC() < -21873 ? (relatedGregorianYear - 1909) + 1 : relatedGregorianYear + 2637 + 61;
        }
