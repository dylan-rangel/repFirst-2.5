...
public class AuthorizationRequest implements AuthorizationManagementRequest {
    ...
    private static final Set<String> BUILT_IN_PARAMS = AdditionalParamsProcessor.builtInParams("client_id", PARAM_CODE_CHALLENGE, PARAM_CODE_CHALLENGE_METHOD, "display", "login_hint", "prompt", "ui_locales", PARAM_REDIRECT_URI, PARAM_RESPONSE_MODE, PARAM_RESPONSE_TYPE, "scope", SentryThread.JsonKeys.STATE, "claims", PARAM_CLAIMS_LOCALES);
    ...
    public Uri toUri() {
        ...
        UriUtil.appendQueryParameterIfNotNull(appendQueryParameter, SentryThread.JsonKeys.STATE, this.state);
    ...
    public JSONObject jsonSerialize() {
        ...
        JsonUtil.putIfNotNull(jSONObject, SentryThread.JsonKeys.STATE, this.state);
    ...
    public static AuthorizationRequest jsonDeserialize(JSONObject json) throws JSONException {
        ...
        return new AuthorizationRequest(AuthorizationServiceConfiguration.fromJson(json.getJSONObject(KEY_CONFIGURATION)), JsonUtil.getString(json, KEY_CLIENT_ID), JsonUtil.getString(json, KEY_RESPONSE_TYPE), JsonUtil.getUri(json, KEY_REDIRECT_URI), JsonUtil.getStringIfDefined(json, "display"), JsonUtil.getStringIfDefined(json, "login_hint"), JsonUtil.getStringIfDefined(json, "prompt"), JsonUtil.getStringIfDefined(json, "ui_locales"), JsonUtil.getStringIfDefined(json, "scope"), JsonUtil.getStringIfDefined(json, SentryThread.JsonKeys.STATE), JsonUtil.getStringIfDefined(json, "nonce"), JsonUtil.getStringIfDefined(json, KEY_CODE_VERIFIER), JsonUtil.getStringIfDefined(json, KEY_CODE_VERIFIER_CHALLENGE), JsonUtil.getStringIfDefined(json, KEY_CODE_VERIFIER_CHALLENGE_METHOD), JsonUtil.getStringIfDefined(json, KEY_RESPONSE_MODE), JsonUtil.getJsonObjectIfDefined(json, "claims"), JsonUtil.getStringIfDefined(json, KEY_CLAIMS_LOCALES), JsonUtil.getStringMap(json, KEY_ADDITIONAL_PARAMETERS));
    }
