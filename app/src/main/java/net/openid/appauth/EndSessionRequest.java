...
public class EndSessionRequest implements AuthorizationManagementRequest {
    private static final Set<String> BUILT_IN_PARAMS = AdditionalParamsProcessor.builtInParams("id_token_hint", "post_logout_redirect_uri", SentryThread.JsonKeys.STATE, "ui_locales");
    ...
    public Uri toUri() {
        ...
        UriUtil.appendQueryParameterIfNotNull(buildUpon, SentryThread.JsonKeys.STATE, this.state);
    ...
    public static EndSessionRequest jsonDeserialize(JSONObject json) throws JSONException {
        ...
        return new EndSessionRequest(AuthorizationServiceConfiguration.fromJson(json.getJSONObject(KEY_CONFIGURATION)), JsonUtil.getStringIfDefined(json, "id_token_hint"), JsonUtil.getUriIfDefined(json, "post_logout_redirect_uri"), JsonUtil.getStringIfDefined(json, SentryThread.JsonKeys.STATE), JsonUtil.getStringIfDefined(json, "ui_locales"), JsonUtil.getStringMap(json, KEY_ADDITIONAL_PARAMETERS));
    }
