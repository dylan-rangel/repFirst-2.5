...
public class TokenResponse {
    ...
    public static TokenResponse jsonDeserialize(JSONObject json) throws JSONException {
        ...
        return new TokenResponse(TokenRequest.jsonDeserialize(json.getJSONObject("request")), JsonUtil.getStringIfDefined(json, KEY_TOKEN_TYPE), JsonUtil.getStringIfDefined(json, KEY_ACCESS_TOKEN), JsonUtil.getLongIfDefined(json, KEY_EXPIRES_AT), JsonUtil.getStringIfDefined(json, "id_token"), JsonUtil.getStringIfDefined(json, "refresh_token"), JsonUtil.getStringIfDefined(json, KEY_SCOPE), JsonUtil.getStringMap(json, KEY_ADDITIONAL_PARAMETERS));
    }
