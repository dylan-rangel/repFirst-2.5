...
public final class Response implements Closeable {
    ...
    public final CacheControl m1993deprecated_cacheControl() {
        return cacheControl();
    }
