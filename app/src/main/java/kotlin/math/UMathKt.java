...
public final class UMathKt {
    ...
    private static final int m1527minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1509minOfJ1ME1BU(i, i2);
    }

    /* renamed from: min-eb3DHEI, reason: not valid java name */
    private static final long m1528mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m1517minOfeb3DHEI(j, j2);
    }

    /* renamed from: max-J1ME1BU, reason: not valid java name */
    private static final int m1525maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1497maxOfJ1ME1BU(i, i2);
    }

    /* renamed from: max-eb3DHEI, reason: not valid java name */
    private static final long m1526maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m1505maxOfeb3DHEI(j, j2);
    }
}
