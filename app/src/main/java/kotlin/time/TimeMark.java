...
public interface TimeMark {
    ...
    TimeMark mo1619minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1621plusLRDsOJo(long duration);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {1, 8, 0}, xi = 48)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m1766plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m1765minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo1621plusLRDsOJo(Duration.m1681unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m1662isNegativeimpl(timeMark.mo1618elapsedNowUwyO8pc());
        }
